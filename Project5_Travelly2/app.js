...
function animateSlides(){
    ...
    sliders.forEach((slide, index, slides) => {
        ...
        pageScene = new ScrollMagic.Scene({
            ...
            duration: "100%",
            triggerHook: 0
        }).setTween(pageTl).setPin(slide, {pushFollowers: false}).addTo(controller);
        /*
        .addIndicators({
            //colorStart: "white",
            //colorTrigger: "white",
    ...
    transitions: [
        {
            ...
            enter({current, next}){
                ...
                //An Animation
                 ...
                 tl.fromTo(".nav-header", { y:"-100%"}, {y:"0%", ease: "power2.inOut"}, "-=0.5");
            }
        }
    ]
});
//Detail animation for fashion page.
